...
def migrate_restrictions(restrictions: dict[str, dict[str, guilds.GuildRestriction]]) -> list[guilds.GuildRestriction]:
    ...
    for restriction_type, restriction_data in restrictions.items():
        for restricted_id, restriction in restriction_data.items():
            new_guild_restrictions.append(guilds.GuildRestriction(
                id=restricted_id,
