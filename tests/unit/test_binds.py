...
class TestNicknames:
        ...
        [
            ...
            (
                ...
                lfc(
                    ...
                    roblox_display_name=lf("test_roblox_user_1.display_name"),
                    roblox_username=lf("test_roblox_user_1.username"),
                ),
            ),
            ...
            (
                ...
                lfc(
                    "[Guest] {} {}".format,
                    lf("test_roblox_user_1.username"),
                    lf("test_roblox_user_1.id"),
                ),
            ),
        ],
    )
    ...
    async def test_nicknames_valid_roblox_user_in_group(self, test_nickname_template, expected_nickname, test_discord_member, test_roblox_user_1, test_guild_1):
        """Test that the nickname is correctly parsed with a valid Roblox user."""
