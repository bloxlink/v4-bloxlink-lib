...
class TestConvertV3WholeGroupBindsToV4:
    ...
    def test_whole_group_bind_length_1(
        self, v3_group_conversion_1
    ...
    def test_whole_group_bind_equals_another(
        self, v3_group_conversion_1
    ):  # pylint: disable=W0621
    ...
    def test_whole_group_equals_another(
        self, v3_group_conversion_1
    ):  # pylint: disable=W0621
        """Test that the converted binds equal the same binds."""
    ...
    def test_whole_group_doesnt_equal_another(
        self, v3_group_conversion_1, v3_group_conversion_2
    ):  # pylint: disable=W0621
...
class TestConvertV3RoleBindsToV4:
    ...
    def test_role_bind_doesnt_equal_different(
        self, v3_rolebinds_1, v3_rolebinds_2
    ):  # pylint: disable=W0621
        """Test that the converted binds don't equal different binds."""
